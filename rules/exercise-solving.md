...
- Mặc định không vẽ free body diagram (FBD) nếu người học không yêu cầu trong `Goal` hoặc `Custom`.

## Chế độ vẽ free body diagram

Dùng khi bài thuộc động lực học hoặc người học yêu cầu vẽ lực, giản đồ lực, FBD.

### Mode 1: `FBD: không vẽ`

- Đây là mặc định.
- Chỉ mô tả lực bằng lời nếu cần cho lời giải.
- Không tạo file hình.

### Mode 2: `FBD: nháp` hoặc `FBD: xấu`

- Vẽ ASCII/text trực tiếp trong chat.
- Dùng khi cần hiểu nhanh vật nào chịu lực nào.
- Không tạo file trong project.
- Phải ghi rõ đang xét vật nào hoặc hệ nào.
